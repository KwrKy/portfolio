...
function toggleScroll() {
    if ($(".audio-player-wrapper,#source-code,.create-content-container").hasClass("open")) {
        $("#spin-text-list").addClass("paused");
    } else if (!$(".audio-player-wrapper,#source-code,.create-content-container").hasClass("open")) {
...
$(function () {
    $("#list-music").click(function () {
        ...
        $('.audio-player-wrapper').addClass('open');
    ...
    $(function () {
        $("#close-media").click(function () {
            ...
            $('.audio-player-wrapper').removeClass('open');
